package com.garyhu.collapp.adapter;
...
import com.garyhu.collapp.widget.refreshrecycler.RefreshAdapter;
...
public class MyRefreshAdapter extends RefreshAdapter<MyRefreshAdapter.DefaultViewHolder> {
    ...
    @Override
    public void onBindThisViewHolder(DefaultViewHolder holder, int position) {
